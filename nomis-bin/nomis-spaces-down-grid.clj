...
(do
  (shell/sh "touch"
            "/Users/simonkatz/development-100/repositories/nomis/dev-setup/nomis-public-dev-setup/nomis-bin/zzzz-nomis-spaces-down-grid-ran")
  (let [current-space (->> (get-desktop-picture-filename)
    ...
    (shell/sh "touch"
              (str "/Users/simonkatz/development-100/repositories/nomis/dev-setup/nomis-public-dev-setup/nomis-bin/zzzz-nomis-spaces-down-grid-ran-"
                   new-space))
