;;; outline-minor-faces-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
minor-Faces mode' mode.  If the prefix argument is positive, enable the
...
evaluate the variable `outline-minor-faces-mode'.
...
(provide 'outline-minor-faces-autoloads)
