;;; paxedit-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
Remove all tabs in the buffer." t)
...
Align all the comments from the point of the cursor onwards." t)
...
Close current round and newline. Faster version of the default paredit close round and newline procedure." t)
(autoload 'paxedit-close-sexp-newline-round "paxedit" "\
Close the current expression, create a newline, and create a new parenthesis pair." t)
(autoload 'paxedit-sexp-raise "paxedit" "\
Raises the expression the cursor is in while perserving the cursor location." t)
...
expression causes the comment to be removed.
 (comment  (message -!-\"hello world\")) ->  (message -!-\"hello world\")" t)
(autoload 'paxedit-macro-expand-replace "paxedit" "\
Replace the current expression (if there is a macro in the functional
position) with its macro expansion." t)
(autoload 'paxedit-sexp-close-statement "paxedit" "\
Faster version of the default paredit close round and newline procedure." t)
(autoload 'paxedit-function-goto-definition "paxedit" "\
Split the current window and display the definition of the function." t)
...
Go to the function definition." t)
...
This is a minor mode.  If called interactively, toggle the `Paxedit
...
evaluate the variable `paxedit-mode'.
