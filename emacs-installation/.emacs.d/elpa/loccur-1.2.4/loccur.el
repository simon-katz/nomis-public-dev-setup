...
;; 2019-10-22  Alexey Veretennikov	 <alexey.veretennikov@gmail.com>
;; 
...
;; 	   were incomplete.
;; 
;; 	    - Then loccur or loccur-no-highlight are called with universal
;; 	prefix,
;; 	   i.e. with C-u before the command, the currently selected value is
;; 	   ignored.
;; 
;; 	    Then people want this behavior by default, it is better wrap the
;; 	call
;; 	   to loccur with universal prefix, i.e. by implementing a helper
;; 	function
;; 	   like this:
...
;; 
;; 	git-subtree-dir: packages/loccur git-subtree-mainline:
;; 	ada08b05a1ff278c1e20d9af60fb22fe9f8e65fc git-subtree-split:
;; 	fb1fbc0ff5da7a8b117542ab8083d29cd79e12b2
;; 
