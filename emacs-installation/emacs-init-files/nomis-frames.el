...
(define-nomis-hydra nomis/modify-frame/resize
  ...
  :hydra-heads (("<up>"        shrink-frame                      "Shrink vertically")
                ...
                ("C-<up>"      (shrink-frame 10)                 "Shrink vertically 10 times")
                ("C-<down>"    (enlarge-frame 10)                "Enlarge vertically 10 times")
                ("C-<left>"    (shrink-frame-horizontally 10)    "Shrink horizontally 10 times")
                ("C-<right>"   (enlarge-frame-horizontally 10)   "Enlarge horizontally 10 times")
