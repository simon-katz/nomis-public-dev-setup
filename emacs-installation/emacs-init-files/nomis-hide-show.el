...
;; (key-chord-define hs-minor-mode-map "q]"  'nomis/hs/adjust/show-all)
;; (key-chord-define hs-minor-mode-map "q="  'nomis/hs/show-all)
;; (key-chord-define hs-minor-mode-map "q/"  'nomis/hs/toggle-hiding)
;; (key-chord-define hs-minor-mode-map "q0"  'nomis/hs/adjust/set-level/0)
;; (key-chord-define hs-minor-mode-map "q1"  'nomis/hs/adjust/set-level/1)
;; (key-chord-define hs-minor-mode-map "q2"  'nomis/hs/adjust/set-level/2)
;; (key-chord-define hs-minor-mode-map "q3"  'nomis/hs/adjust/set-level/3)
;; (key-chord-define hs-minor-mode-map "q4"  'nomis/hs/adjust/set-level/4)
;; (key-chord-define hs-minor-mode-map "q5"  'nomis/hs/adjust/set-level/5)
;; (key-chord-define hs-minor-mode-map "q6"  'nomis/hs/adjust/set-level/6)
;; (key-chord-define hs-minor-mode-map "q7"  'nomis/hs/adjust/set-level/7)
;; (key-chord-define hs-minor-mode-map "q8"  'nomis/hs/adjust/set-level/8)
;; (key-chord-define hs-minor-mode-map "q9"  'nomis/hs/adjust/set-level/9)
...
(define-key hs-minor-mode-map (k•• "H-q H-m") 'nomis/scrolling/toggle-maintain-line-no-in-window)
...
;;;; (key-chord-define hs-minor-mode-map "qj" 'nomis/hs/step-forward)
;;;; (key-chord-define hs-minor-mode-map "qk" 'nomis/hs/step-backward)
