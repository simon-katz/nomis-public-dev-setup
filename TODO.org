...
- Do you have other things that should be modes (like nomis-right-margin-mode)?

+ Report this bug in Emacs 24.3:
...
- You have some manually-installed packages in "for-me/nomis-addons".
  Instead, (after .emacs.d and .emacs are in the same repository (if
  you do that)), put the manually-installed packages in .emacs.d.

- Move some stuff from "for-me" to "for-anyone".

- Compiling
  - Look into any compilation errors and warnings now, and do so when
    you make changes.
